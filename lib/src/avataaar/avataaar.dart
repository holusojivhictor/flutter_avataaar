...
class Avataaar implements AvataaarPart {
  ...
  Future<File> getPngFromSvg(
    ...
    try {
      ...
      var pictureInfo = await vg.loadPicture(
        SvgBytesLoader(unit8Picture),
        context,
      );
      ...
      var image = await pictureInfo.picture
      ...
      var file = File(
          '${path ?? (await getTemporaryDirectory()).path}/${fileName ?? Uuid().v4()}.png');
